      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid items-start gap-14 lg:grid-cols-[290px_1fr] lg:gap-14">
          ...
          <div className="mx-auto w-full max-w-[280px] pt-3 lg:mx-0">
            <div className="relative rounded-sm border border-ink-900/5 bg-paper-card p-5 pb-7 text-center shadow-xl shadow-ink-900/10">
            ...
            <div className="relative mx-auto -mt-5 flex w-fit items-center gap-2 rounded-full border border-brand-900/10 bg-white px-4 py-2 shadow-md">
            ...
            {/* Hindi motto */}
            <div className="mt-8 rounded-sm border-l-4 border-brand-500 bg-paper-card p-4 shadow-sm">
              <p
                lang="hi"
