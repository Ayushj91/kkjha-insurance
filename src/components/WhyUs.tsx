            ...
            return (
              ...
              >
                <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-500 to-brand-600 text-white shadow-md shadow-brand-600/20">
                  ...
                  <span className="font-hand absolute -bottom-2.5 -right-2.5 flex h-6 w-6 -rotate-6 items-center justify-center rounded-full bg-ink-900 text-[10px] font-bold text-white ring-2 ring-brand-50/40">
                    {i + 1}
                  </span>
                </div>
                <div>
